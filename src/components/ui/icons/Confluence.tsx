...
export function Confluence(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient
          id="deviconConfluence0"
          x1="26.791"
          x2="11.792"
          y1="28.467"
          y2="19.855"
          gradientTransform="translate(-21.334 -18.666)scale(5.33331)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#0052cc"></stop>
          <stop offset=".918" stopColor="#2380fb"></stop>
          <stop offset="1" stopColor="#2684ff"></stop>
        </linearGradient>
        <linearGradient
          id="deviconConfluence1"
          x1="5.209"
          x2="20.208"
          y1="2.523"
          y2="11.136"
